...
export const PROGRESS_TYPE_ORDER = new Map<ProgressType, number>([
  ...
  [ProgressType.CONNECTION_FETCH, 7],
  [ProgressType.CONNECTION_SAVE, 8],
  [ProgressType.CONNECTION_DELETE, 9],
  [ProgressType.VIEW_FETCH, 10],
  [ProgressType.LAYER_CACHE, 11],
  [ProgressType.QUADTILE_CACHE, 12],
  [ProgressType.MAXMERGE_SCHEDULE, 13],
  [ProgressType.MAXMERGE_CACHE, 14],
  [ProgressType.HISTOGRAM_SCHEDULE, 15],
  [ProgressType.HISTOGRAM_CACHE, 16],
  [ProgressType.MOVIE_GENERATION, 17],
  [ProgressType.SNAPSHOT_BATCH_DOWNLOAD, 18],
  [ProgressType.GENERIC, 19],
]);
