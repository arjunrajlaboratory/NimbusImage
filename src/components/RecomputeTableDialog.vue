    ...
    <v-card>
      ...
      <v-card-text>
        <p class="text-body-2 mb-3">
          ...
          table is kept as a version. Edited-cell rebuilds also update neighbors
          in the cells' previous locations. Older tables without saved cell
          footprints require a full rebuild once.
        </p>
        <v-text-field
          v-model="label"
          label="Version label"
